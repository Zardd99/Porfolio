  ...
  return (
    <>
      <section
        ...
        id="hero"
      >
        <h2 className="hero__subtitle text-4xl font-semibold text-blue-400">
          {subtitle}
        </h2>
        <h1 className="hero__title text-6xl font-black ">
          {title} <br /> {title2}{" "}
        </h1>
        <p className="hero__description w-[60ch] text-slate-600 text-lg">
          {description} <br />
